    ...
    <div className='w-[305px] min-h-[268px] bg-gray border-2 border-[#505568] rounded-[20px] p-5 z-10 md:w-[430px] md:min-h-[256px] md:py-[30px] md:px-[31px]'>
      <div className="flex flex-row items-center justify-start gap-[11px]">
        ...
        <div className="flex flex-col justify-start items-start">
          ...
          <div className="font-400 hidden flex-row items-center justify-center w-full mt-1 md:flex md:justify-start">
            {country.capital && (
      ...
      {country.currency && (
        <div className="flex flex-col w-full justify-start items-start mt-5 gap-[5px] font-semibold text-white border-gray2 border-b pb-2">
          <p className="text-base open-sans">Currency</p>
          <div className="flex flex-row items-center justify-start gap-[5px]">
            ...
            {country.currency.split(",").length > 1 && (
              <span>+{country.currency.split(",").length - 1}</span>
            )}
          </div>
        </div>
      )}
      {country.languages.length > 0 && (
        <div className="flex flex-col w-full justify-start items-start gap-[5px] font-semibold text-white">
          <p className="text-base open-sans">Languages</p>
          <div className="flex flex-row items-center justify-start gap-[5px]">
            {country.languages.length > 0 && country.languages.slice(0, 2).map((language: Language, index: number) => (
